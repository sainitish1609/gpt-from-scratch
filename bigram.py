...
# hyperparameters
batch_size = 64 # amount of independent sequences will we process in parallel?
...
if __name__ == '__main__':
    ...
    for iter in range(max_iters):
        ...
        if iter % eval_interval == 0 or iter == max_iters - 1:
            ...
            now = datetime.now()
            print(f"step {iter}: train loss {losses['train']:.4f}, val loss {losses['val']:.4f} {now.strftime('%H:%M:%S.%f')}")
